...
import { CreditCard, Building, User, Mail, Lock, Check } from 'lucide-react';
                ...
                <div className="flex gap-4 mt-8">
                  {step > 1 && (
                    <button
                      ...
                      className="px-6 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                    >
                      Voltar
                    </button>
                  )}
                  <button
                    onClick={() => step < 3 ? setStep(step + 1) : window.location.href = '/obrigado'}
                    className="flex-1 bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-xl transition-all"
                  >
                    {step < 3 ? 'Continuar' : 'Iniciar Trial Gratuito'}
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white">Profissional</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white">R$ 697/mês</span>
                  </div>
                </div>
