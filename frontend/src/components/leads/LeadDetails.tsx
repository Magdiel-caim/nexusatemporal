      ...
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 mb-6">
        ...
        {activeTab === 'details' && lead && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-900/50 transition-colors"
          >
              ...
              <div className="border-t dark:border-gray-700 pt-6">
                ...
                {appointments.length === 0 ? (
                  <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-center">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Nenhum agendamento registrado</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {appointments.map((apt) => (
                      <div key={apt.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
