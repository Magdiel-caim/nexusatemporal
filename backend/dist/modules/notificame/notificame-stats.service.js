...
class NotificaMeStatsService {
     ...
     */
    async getMessageHistory(tenantId, days = 30) {
        const db = (0, database_1.getAutomationDbPool)();
        const query = `
      SELECT
...
exports.NotificaMeStatsService = NotificaMeStatsService;
exports.default = new NotificaMeStatsService();
//# sourceMappingURL=notificame-stats.service.js.map