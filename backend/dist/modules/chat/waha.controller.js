...
const waha_service_1 = __importDefault(require("./waha.service"));
...
const wahaService = new waha_service_1.default(wahaConfig);
/**
...
router.post('/chats/:chatId/messages/read', async (req, res) => {
    try {
        const { chatId } = req.params;
