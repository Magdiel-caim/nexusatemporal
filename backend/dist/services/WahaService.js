...
class WahaService {
     ...
     */
    async handleAckWebhook(payload) {
     ...
     */
    async handleSessionStatusWebhook(payload) {
     ...
     */
    async waitForConnection(session, timeout = 60000, checkInterval = 2000) {
...
//# sourceMappingURL=WahaService.js.map